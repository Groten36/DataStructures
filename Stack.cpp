...
Stack::Stack(const Stack& stack):top_(stack.top_),capacity_(stack.capacity_),stack_(nullptr){
    stack_=new int[capacity_];
...
Stack::Stack(Stack&& stack)noexcept:top_(stack.top_),capacity_(stack.capacity_),stack_(stack.stack_){
...
int Stack::capacity() const noexcept{
    return capacity_;
}
