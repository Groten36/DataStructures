...
DynamicArray::~DynamicArray() { delete[] array_; }
...
void DynamicArray::push_back(int element) {
  if (size_ >= capacity_)
    resizeArray(capacity_ == 0 ? 1 : capacity_ * 2);
...
size_t DynamicArray::capacity() const noexcept { return capacity_; }

size_t DynamicArray::size() const noexcept { return size_; }

bool DynamicArray::empty() const noexcept { return size_ == 0; }
...
void DynamicArray::clear() noexcept { size_ = 0; }

int *DynamicArray::begin() noexcept { return array_; }

int *DynamicArray::end() noexcept { return array_ + size_; }

const int *DynamicArray::begin() const noexcept { return array_; }
const int *DynamicArray::end() const noexcept { return array_ + size_; }
